...
<script type="text/javascript" src="<?php echo JS_PATH;?>guanyue/header.js"></script>

<link rel="stylesheet" href="<?php echo CSS_PATH;?>guanyue/public.css">
<link rel="stylesheet" href="<?php echo CSS_PATH;?>guanyue/style.css">
...
<div class="head">
<div class="top">
   	<div id="topNav" class="docbody">
        <div class="leftNav">下午好，欢迎访问中国音协管乐学会 </div>
        <div class="rightNav">
          <a class="login" href="">登陆</a><a class="login" href="#">注册</a>&nbsp;&nbsp;
          <a href="#" class="txt_d">忘记密码</a>
        </div>
        </div>
  </div>
       <div class="docbody clearfix">
       <a class="logo" href="#">中国音协助管乐园会</a>
       <p class="share">
        <a href="#" class="sina"></a>
...
<div class="header">
	<div class="logo"><a href="<?php echo siteurl($siteid);?>/"><img src="<?php echo IMG_PATH;?>guanyue/logo.png" /></a></div>
