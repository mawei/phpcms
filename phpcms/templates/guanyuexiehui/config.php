<?php return array (
  'name' => '管乐协会模板',
  'author' => '一隼科技',
  'dirname' => 'guanyuexiehui',
  'homepage' => 'http://www.phpcms.cn/',
  'version' => '1.0',
  'disable' => 0,
  'file_explan' => 
  array (
    'templates|guanyuexiehui|content' => 
    array (
      'category.html' => '文章频道页',
    ...
    'templates|guanyuexiehui|link' => 
    array (
      'index.html' => '',
      'list_type.html' => '分类页',
      'register.html' => '申请页',
    ),
    'templates|guanyuexiehui|special' => 
    array (
      'api_picture.html' => '组图',
    ...
    'templates|guanyuexiehui|poster' => 
    array (
      'banner.html' => '矩形横幅',
      'couplet.html' => '对联广告',
      'fixure.html' => '固定位置',
    ...
    'templates|guanyuexiehui|announce' => 
    array (
      'show.html' => '内容页',
    ),
    'templates|guanyuexiehui|wap' => 
    array (
    ...
    'templates|guanyuexiehui|message' => 
    array (
      'group.html' => '系统消息',
      'inbox.html' => '收件箱',
      'outbox.html' => '发件箱',
    ...
    'templates|guanyuexiehui|member' => 
    array (
    ...
    'templates|guanyuexiehui|phpsso' => 
    array (
      'index.html' => '首页',
    ),
    'templates|guanyuexiehui|search' => 
    array (
      'footer.html' => '页尾',
      'header.html' => '页头',
      'index.html' => '首页',
    ...
    'templates|guanyuexiehui|formguide' => 
    array (
      'index.html' => '表单列表页模板',
      'show.html' => '表单详情页模板',
      'show_js.html' => '表单js调用模板',
    ),
    'templates|guanyuexiehui|mood' => 
    array (
      'index.html' => '新闻心情',
    ),
    'templates|guanyuexiehui|yp' => 
    array (
      'com_default' => '企业默认模板',
      'index.html' => '黄页首页模板',
      'list.html' => '列表页模板',
    ...
    'templates|guanyuexiehui|yp|com_default' => 
    array (
      'index.html' => '公司首页模板',
      'style' => '样式文件夹',
    ),
    'templates|guanyuexiehui|comment' => 
    array (
